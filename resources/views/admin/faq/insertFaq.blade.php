...
<header class="page-header">
   <h2>{{empty($data['id'])?'Buat':'Ubah'}} FaQ </h2>
</header>
   ...
   <div class="col">
      ...
      <section class="card card-modern card-big-info">
         <div class="card-body text-color-dark p-4">
               <form action="{{empty($data['id'])?route('faq.insert'):route('faq.update')}}" method="post" enctype="multipart/form-data">
                  @csrf @method('POST')
						<div class="row col-6">
                  ...
                  <div class="form-group col-12">
                    ...
                    <textarea id="description" name="deskripsi" class="form-contol">{!! !empty($data['id'])?$data['deskripsi']:'' !!}</textarea>
                  </div>
