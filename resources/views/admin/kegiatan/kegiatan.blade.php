...
<div class="row">
   ...
   <section class="card m-0">
      <div class="card-body">
         <section class="card">
            <div class="card-body">
               <a href="{{route('kegiatan.create')}}" class="btn btn-success float-end"><i class="fa fa-plus"></i> Tambah</a>
            </div>
         </section>
         <div class="card">
            <div class="card-body">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                           <a href="javascript:void(0);" data-id="{{$item['id']}}" title="Lihat" class="btn btn-small btn-info preview">
                              <i class="fa fa-search"></i>
                           </a>
                        </td>
                        <td class="text-center">
                           {{-- <img src="{{ asset('/storage/img/kegiatan/'.$item['img']) }}" height="50" style="object-fit: contain"> --}}
                           
                           <img src="{{ Storage::url('public/img/kegiatan/').$item['img'] }}" height="50" style="object-fit: contain">
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                           <a href="{{route('kegiatan.edit',$item['id'])}}" title="Ubah" class="btn btn-small btn-warning"><i class="fa fa-edit"></i></a>
                           <a href="javascript:void(0);" onclick="confirmDelete('{{route('kegiatan.destroy',$item['id'])}}')" title="Hapus" class="btn btn-small btn-danger"><i class="fa fa-trash"></i></a>
                        </td>
                     </tr>
                     @endforeach
                  </tbody>
