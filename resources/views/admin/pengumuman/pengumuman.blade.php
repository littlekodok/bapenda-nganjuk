   ...
   <section class="card">
      <div class="card-body">
         <h3> 
            ...
            <input id="chkToggle" type="checkbox" onchange="changeMaster({{$data['master']['id']}})" data-toggle="toggle" data-onstyle="success" data-offstyle="danger">
         </h3>
         <input type="hidden" id="masterval" value="{{$data['master']['isactive']}}">
      </div>
   </section>
   <hr>
   <section class="card m-0">
      <div class="card-body">
         <div class="card-body">
            <section class="card">
               <div class="card-body">
                  <a href="{{route('pengumuman.create')}}" class="btn btn-success float-end"><i class="fa fa-plus"></i> Tambah</a>
               </div>
            </section>
            <div class="card">
               <div class="card-body">
                  <table id="tablepengumuman" class="table table-bordered" style="width:100%">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-center">
                              <a href="{{route('pengumuman.show',$item['id'])}}" title="Ubah" class="btn btn-small btn-warning"><i class="fa fa-edit"></i></a>
                              <a href="javascript:void(0);" onclick="confirmDelete('{{route('pengumuman.destroy',$item['id'])}}')" title="Hapus" class="btn btn-small btn-danger"><i class="fa fa-trash"></i></a>
                           </td>
                        </tr> 
                        @endforeach
                     </tbody>
...
@section('js')
   ...
   <script>
      ...
      function changeMaster(id){
         ...
         $.ajax({
            url : '{{route('masterpengumuman.isactive')}}',
            data: {
               id: id, isactive: isactive
            },
            type: 'POST',
