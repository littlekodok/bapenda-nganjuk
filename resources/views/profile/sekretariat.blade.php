...
<div class="body">
   ...
   <footer id="footer" class="border-0" style="background-image: url({{asset('img/footer.jpg')}})">
      <div class="container py-4">
         <div class="row justify-content-md-center py-5 mt-3">
            ...
            <div class="col-md-6 col-lg-3 text-center text-lg-start mb-5 mb-lg-0">
               ...
               <ul class="list list-unstyled text-color-light">
                  <li class="mb-1"><a href="{{ route('landing') }}#visimisi" class="link-hover-style-1 text-3"> Visi Misi</a></li>
                  ...
                  <li class="mb-1"><a href="{{ route('landing') }}#ppid" class="link-hover-style-1 text-3"> PPID</a></li>
