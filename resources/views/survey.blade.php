               ...
               <div class="header-column">
                  <div class="header-row">
                     <div class="header-logo">
                        <a href="#">
                           <img alt="Inspektorat Kota Surakarta" width="auto" height="40" src="{{ asset('img/logo-ska.png')}}">
                        </a>
                     </div>
                  </div>
               </div>
         ...
         <div class="text-center p-3">
            <div class="row">
               <div class="col-12" style="margin-top:50px">
                  ...
                  {{-- <iframe src="https://egov.phicos.co.id/surakarta/sop-surakarta/skm/instrumen/isi/46"  height="100%" width="100%" style="display: block;"></iframe> --}}
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="row justify-content-md-center py-5 mt-3">
            <div class="col-md-12 col-lg-3 d-flex align-items-center justify-content-center justify-content-lg-start mb-5 mb-lg-0">
               <a href="#" class="text-center">
                  <img src="{{asset('img/surakarta.png')}}" alt="Logo" class="img-fluid" style="max-width: 100px;">
            ...
            <div class="col-md-6 col-lg-3 text-center text-lg-start mb-5 mb-lg-0">
               ...
               <ul class="list list-unstyled text-color-light">
                  <li class="mb-1"><a href="{{url('')}}#visimisi" class="link-hover-style-1 text-3"> Visi Misi</a></li>
                  <li class="mb-1"><a href="{{url('')}}#kegiatan" class="link-hover-style-1 text-3"> Kegiatan</a></li>
                  <li class="mb-1"><a href="{{url('')}}#pelayanan" class="link-hover-style-1 text-3"> Pelayanan</a></li>
                  <li class="mb-1"><a href="{{url('')}}#ppid" class="link-hover-style-1 text-3"> PPID</a></li>
