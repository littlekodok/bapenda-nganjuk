...
<header class="page-header">
   <h2><?php echo e(empty($data['id'])?'Buat':'Ubah'); ?> Kegiatan</h2>
</header>
   ...
   <div class="col">
      ...
      <section class="card card-modern card-big-info">
         <div class="card-body text-color-dark p-4">
               <form action="<?php echo e(empty($data['id'])?route('kegiatan.insert'):route('kegiatan.update')); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row col-6">
							<div class="form-group mb-3 col-md-4">
								...
								<input id="publish" type="text" class="form-control datetimepicker-input" name="tgl_publish" required 									
									...
									value="<?php echo e(!empty($data['id'])?date('d-m-Y' ,strtotime($data['publish_at'])):''); ?>"/>
							</div>
						</div>
                  <div class="row col-6">
                     <div class="form-group mb-3">
                        ...
                        <input id="title" type="text" class="form-control" name="judul" required  									
								oninvalid="this.setCustomValidity('Isian tidak boleh kosong')"
								oninput="setCustomValidity('')"
								value="<?php echo e(!empty($data['id'])?$data['title']:''); ?>">
                     </div>
                  </div>
                  <div class="form-group col-12">
                     ...
                     <textarea id="description" name="deskripsi" class="form-contol"><?php echo !empty($data['id'])?$data['content']:''; ?></textarea>
                  </div>
                  <div class="form-group col-6">
                        ...
                        <img class="mt-3 mb-4" src="<?php echo e(Storage::url('public/img/kegiatan/').$data['img']); ?>" height="50" style="object-fit: contain">
                        <?php endif; ?>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\apllication\solo-inspektorat-website-master\resources\views/admin/kegiatan/insertKegiatan.blade.php ENDPATH**/ ?>