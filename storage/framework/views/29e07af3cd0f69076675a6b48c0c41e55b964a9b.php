   ...
   <section class="card m-0">
      <div class="card-body">
         <div class="card-body">
            <section class="card">
               <div class="card-body">
                  <a href="<?php echo e(route('runningtext.create')); ?>" class="btn btn-success float-end"><i class="fa fa-plus"></i> Tambah</a>
               </div>
            </section>
            <div class="card">
               <div class="card-body">
                  <table id="tablerunningtext" class="table table-bordered" style="width:100%">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-center">
                              <a href="<?php echo e(route('runningtext.show',$item['id'])); ?>" title="Ubah" class="btn btn-small btn-warning"><i class="fa fa-edit"></i></a>
                              <a href="javascript:void(0);" onclick="confirmDelete('<?php echo e(route('runningtext.destroy',$item['id'])); ?>')" title="Hapus" class="btn btn-small btn-danger"><i class="fa fa-trash"></i></a>
                           </td>
                        </tr> 
...
<script>
   $(document).ready(function () {
      ...
      $('.isactive').on('click', function(){
         ...
         $.ajax({
            url : '<?php echo e(route('runningtext.isactive')); ?>',
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\apllication\solo-inspektorat-website-master\resources\views/admin/runningtext/runningtext.blade.php ENDPATH**/ ?>