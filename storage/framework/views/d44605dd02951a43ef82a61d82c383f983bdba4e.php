         ...
         <div class="row">
            <div class="bg-dark text-center col-12">
               <div class="p-4 text-color-light text-5 font-weight-bold appear-animation hone" data-appear-animation="fadeInDownShorter">
                  <?php echo e(!empty($data['linefirst'])?$data['linefirst']:'INSPEKTORAT'); ?>
            ...
            <div id="ubahtextone" class="ubah col-12">
               ...
               <div class="input-group mb-3">
                  <input type="text" class="form-control" value="<?php echo e(!empty($data['linefirst'])?$data['linefirst']:''); ?>" id="textone" required>
                  <?php if(!empty($data)): ?>
         ...
         <div class="row">
            <div class="bg-dark text-center col-12">
               <p class="htwo text-color-danger text-center font-weight-extra-bold text-lg-18 text-md-14-15 text-sm-13 text-xs-14 mb-4 mt-4 appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="500" data-plugin-options="{'startDelay': 500, 'minWindowWidth': 0}">
                  <?php echo e(!empty($data['linesecondw'])?$data['linesecondw']:'KOTA'); ?> <span class="position-relative text-secondary"><?php echo e(!empty($data['linesecondr'])?$data['linesecondr']:'SURAKARTA'); ?></span>
               </p>
            </div>
            <div class="col-12 mt-2">
            ...
            <div id="ubahtexttwo" class="ubah col-12">
               <div class="form-group mb-1">
                  ...
                  <input type="text" class="form-control" value="<?php echo e(!empty($data['linesecondw'])?$data['linesecondw']:''); ?>" id="texttwow">
               </div>
               <div class="form-group mb-1">
                  <label for="name"><h4 class="mb-2 font-weight-semibold text-dark"><i class="fas fa-keyboard"></i> &nbsp; Text Warna Kuning</h4></label>
                  <input type="text" class="form-control" value="<?php echo e(!empty($data['linesecondr'])?$data['linesecondr']:''); ?>" id="texttwor">
               </div>
               <div class="form-group mb-1">
                  <?php if(!empty($data)): ?>
...
<div class="row">
   <section class="card mb-3">
      <div class="card-body">
         <div class="row">
            <div class="bg-dark text-center col-12">
               <p class="hthree text-5 text-color-light font-weight-light opacity-7 text-center mt-4"  data-appear-animation="zoomInDown" data-plugin-options="{'startDelay': 1000,'minWindowWidth': 0, 'animationSpeed': 25}"><?php echo e(!empty($data['linethrith'])?$data['linethrith']:'Smart, Integritas, Profesional'); ?></p>
            </div>
            <div class="col-12 mt-2">
            ...
            <div id="ubahtextthree" class="ubah col-12">
               ...
               <div class="input-group mb-3">
                  <input type="text" class="form-control" value="<?php echo e(!empty($data['linethrith'])?$data['linethrith']:''); ?>" id="textthree">
                  <?php if(!empty($data)): ?>
...
<div class="row">
   <section class="card mb-3">
      <div class="card-body">
         <div class="row">
            <div class="col-12">
               <div class="hfour owl-item position-relative overlay overlay-show overlay-op-8 pt-5" style="background-image: url(<?php echo e(!empty($data['background'])?Storage::url('public/img/').$data['background']:asset('/img/herobg.jpeg')); ?>); background-size: contain; background-position: center; height: 300px; background-repeat: no-repeat;"></div>
            </div>
            <div class="col-12 mt-2">
            ...
            <div id="ubahtextfour" class="ubah col-12">
               ...
               <form action="<?php echo e(route('header.updatebg')); ?>" method="POST" enctype="multipart/form-data" id="image-upload">
                  <?php echo csrf_field(); ?>
                  <div class="input-group mb-3">
                     <input type="hidden" name="id" id="id" value="<?php echo e(!empty($data) ? $data['id'] : ''); ?>">
...
<script>
   ...
   function update(target){
      ...
      $.ajax({
         url : '<?php echo e(route('header.update')); ?>',
         data: {
         ...
         success: function(data){
            ...
            setTimeout(function(){
               window.location.href = "<?php echo e(route('header.index')); ?>";
            }, 1500);
         }
      });
   }
...
<?php echo $__env->make('admin/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\apllication\solo-inspektorat-website-master\resources\views/admin/header/header.blade.php ENDPATH**/ ?>