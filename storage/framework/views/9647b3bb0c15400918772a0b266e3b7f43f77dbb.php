...
<div class="row">
   ...
   <section class="card m-0">
      <div class="card-body">
         <section class="card">
            <div class="card-body">
               <a href="<?php echo e(route('kegiatan.create')); ?>" class="btn btn-success float-end"><i class="fa fa-plus"></i> Tambah</a>
            </div>
         </section>
         <div class="card">
            <div class="card-body">
               <table id="tablekegiatan" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                     <th>No</th>
                     <th>Judul</th>
                     <th>Deskripsi</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                           <a href="javascript:void(0);" data-id="<?php echo e($item['id']); ?>" title="Lihat" class="btn btn-small btn-info preview">
                        ...
                        <td class="text-center">
                           ...
                           <img src="<?php echo e(Storage::url('public/img/kegiatan/').$item['img']); ?>" height="50" style="object-fit: contain">
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                           <a href="<?php echo e(route('kegiatan.edit',$item['id'])); ?>" title="Ubah" class="btn btn-small btn-warning"><i class="fa fa-edit"></i></a>
                           <a href="javascript:void(0);" onclick="confirmDelete('<?php echo e(route('kegiatan.destroy',$item['id'])); ?>')" title="Hapus" class="btn btn-small btn-danger"><i class="fa fa-trash"></i></a>
                        </td>
                     </tr>
...
$(document).ready(function () {
   ...
   $('.isactive').on('click', function(){
      ...
      $.ajax({
         url : '<?php echo e(route('kegiatan.isactive')); ?>',
         data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\apllication\solo-inspektorat-website-master\resources\views/admin/kegiatan/kegiatan.blade.php ENDPATH**/ ?>