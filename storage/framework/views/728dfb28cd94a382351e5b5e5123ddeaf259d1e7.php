...
<header class="page-header">
   <h2><?php echo e(empty($data['id'])?'Buat':'Ubah'); ?> FaQ </h2>
</header>
   ...
   <div class="col">
      ...
      <section class="card card-modern card-big-info">
         <div class="card-body text-color-dark p-4">
               <form action="<?php echo e(empty($data['id'])?route('faq.insert'):route('faq.update')); ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-12">
                    ...
                    <textarea id="description" name="deskripsi" class="form-contol"><?php echo !empty($data['id'])?$data['deskripsi']:''; ?></textarea>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\apllication\solo-inspektorat-website-master\resources\views/admin/faq/insertFaq.blade.php ENDPATH**/ ?>