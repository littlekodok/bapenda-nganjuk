...
<div class="body">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 align-self-center p-static order-2 text-center">
                  <h1 class="text-dark mt-3 font-weight-bold text-8">Profil Sekretariat</h1>
               </div>
                  ...
                  <article class="post post-large blog-single-post border-0 m-0 p-0">
                     <div class="post-image ms-0">
                        <a href="blog-post.html">
                           <img src="<?php echo e(Storage::url('public/img/kegiatan/'.$data['kegiatan']['img'])); ?>" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="">
                        </a>
                     </div>
   ...
   <footer id="footer" class="border-0" style="background-image: url(<?php echo e(asset('img/footer.jpg')); ?>)">
         ...
         <div class="row justify-content-md-center py-5 mt-3">
            ...
            <div class="col-md-6 col-lg-3 text-center text-lg-start mb-5 mb-lg-0">
               ...
               <ul class="list list-unstyled text-color-light">
                  <li class="mb-1"><a href="<?php echo e(route('landing')); ?>#visimisi" class="link-hover-style-1 text-3"> Visi Misi</a></li>
                  ...
                  <li class="mb-1"><a href="<?php echo e(route('landing')); ?>#ppid" class="link-hover-style-1 text-3"> PPID</a></li>
            ...
            <div class="col-md-6 col-lg-3 text-center text-lg-start">
               <h5 class="text-5 text-transform-none font-weight-semibold text-color-light mb-4">Contact Us</h5>
                  <ul class="list list-icons list-icons-lg">
                     <li class="mb-1 text-3"><i class="fas fa-map-marker-alt text-color-primary"></i><p class="m-0">Jl. Merdeka No. 3. Kel. Mangundikaran, Nganjuk</p></li>
                     <li class="mb-1 text-3"><i class="fas fa-phone text-color-primary"></i><p class="m-0"><a href="tel:0358325222">(0358) 325222</a></p></li>
                     <li class="mb-1 text-3"><i class="far fa-envelope text-color-primary"></i><p class="m-0"><a href="mailto:bapendanganjuk@gmail">bapendanganjuk@gmail.com</a></p></li>
                  </ul>
      ...
      <div class="footer-copyright footer-copyright-style-2  footer-top-light-border" style="background-color: #0098da">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\apllication\solo-inspektorat-website-master\resources\views/profile/sekretariat.blade.php ENDPATH**/ ?>