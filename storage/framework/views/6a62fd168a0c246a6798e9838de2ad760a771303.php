            ...
            <div class="tabs-modern row" style="min-height: 490px;">
               ...
               <div class="col-lg-3-5 col-xl-4-5">
                  <div class="tab-content" id="tabContent">
                        <div class="tab-pane fade <?php echo e($from=='misi'?'':'show active'); ?>" id="visi" role="tabpanel" aria-labelledby="visi-tab">
                           <input type="hidden" id="idvisi" value="<?php echo e(!empty($visi) ? $visi['id'] : ''); ?>">
                           <section class="card">
                              <div class="card-body">
                                 <div class="row">
                                    ...
                                    <?php if(empty($visi)): ?>
                                    <div class="col-6">
                                       <a href="<?php echo e(route('visi.create')); ?>" class="btn btn-success float-end"><i class="fa fa-plus"></i> Tambah</a>
                                    </div>                                        
                                    <?php endif; ?>
                                 </div>
                              </div>
                           ...
                           <section class="card mb-4">
                              <div class="card-body text-color-dark font-weight-bold">
                                 <h3 class="font-weight-bold m-none hone">
                                    <?php echo e(!empty($visi['textfirst'])?$visi['textfirst']:'Mewujudkan'); ?>
                              ...
                              <div class="card-body p-3" style="background-color: #ecedf0">
                                 <div id="ubahtextone" class="ubah mt-3 col-12">
                                    ...
                                    <div class="input-group mb-3">
                                       <input type="text" class="form-control" value="<?php echo e(!empty($visi['textfirst'])?$visi['textfirst']:''); ?>"  									
                                       oninvalid="this.setCustomValidity('Isian tidak boleh kosong')"
                                       oninput="setCustomValidity('')"
                                       id="textone" required>
                                       <?php if(!empty($visi['id'])): ?>
                           ...
                           <section class="card mb-4">
                              <div class="card-body text-color-dark font-weight-bold">
                                 <h3 class="font-weight-bold m-none htwo">
                                    <span class="alternative-font"><?php echo e(!empty($visi['textalternative'])?$visi['textalternative']:'Surakarta'); ?></span>
                                 </h3>
                                 <div class="card-actions">
                              ...
                              <div class="card-body p-3" style="background-color: #ecedf0">
                                 <div id="ubahtexttwo" class="ubah mt-3 col-12">
                                    <label for="name"><h4 class="mb-2 font-weight-semibold text-dark"><i class="fas fa-keyboard"></i> &nbsp; Text</h4></label>
                                    <div class="input-group mb-3">
                                       <input type="text" class="form-control" value="<?php echo e(!empty($visi['textalternative'])?$visi['textalternative']:''); ?>" 									
                                       oninvalid="this.setCustomValidity('Isian tidak boleh kosong')"
                                       oninput="setCustomValidity('')"
                                        id="texttwo" required>
                                       <?php if(!empty($visi['id'])): ?>
                           ...
                           <section class="card mb-4">
                              <div class="card-body text-color-dark font-weight-bold">
                                 <h3 class="font-weight-bold m-none hthree">
                                    <?php echo e(!empty($visi['textsecond'])?$visi['textsecond']:'sebagai Kota Budaya yang'); ?>
                              ...
                              <div class="card-body p-3" style="background-color: #ecedf0">
                                 <div id="ubahtextthree" class="ubah mt-3 col-12">
                                    <label for="name"><h4 class="mb-2 font-weight-semibold text-dark"><i class="fas fa-keyboard"></i> &nbsp; Text</h4></label>
                                    <div class="input-group mb-3">
                                       <input type="text" class="form-control" value="<?php echo e(!empty($visi['textsecond'])?$visi['textsecond']:''); ?>"  									
                                       oninvalid="this.setCustomValidity('Isian tidak boleh kosong')"
                                       oninput="setCustomValidity('')"
                           ...
                           <section class="card mb-4">
                                 ...
                                 <h3 class="font-weight-bold m-none hfour">
                                    <span class="text-color-primary wort-rotator word active" style="height: 30px;">
                                       <span class="wort-rotator-items" style="vertical-align: bottom">
                                          <?php if(!empty($visi['textanimation'])): ?>
                                             <?php
                              ...
                              <div class="card-body p-3" style="background-color: #ecedf0">
                                 <div id="ubahtextfour" class="ubah mt-3 col-12">
                                    <label for="name"><h4 class="mb-2 font-weight-semibold text-dark"><i class="fas fa-keyboard"></i> &nbsp; Text</h4></label>
                                    <div class="input-group mb-3">
                                       <input type="text" class="form-control" value="<?php echo e(!empty($visi['textanimation'])?$visi['textanimation']:''); ?>" id="textfour" required>
                                       <?php if(!empty($visi['id'])): ?>
                                 ...
                                 <table id="tablemisi" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td class="text-center">
                                             <a href="<?php echo e(route('misi.show',$item['id'])); ?>" title="Ubah" class="btn btn-small btn-warning"><i class="fa fa-edit"></i></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\apllication\solo-inspektorat-website-master\resources\views/admin/visimisi/visimisi.blade.php ENDPATH**/ ?>